...
```
**8.9 pp improvement** from lowest to highest literacy level.
...
**Intervention:** $13K (KES 1,300) emergency liquidity facility  
**Current Gap:** Only 45% can access 13K in 1 month  
**Estimated Impact:** +819 individuals prevented from worsening
...
**Cost-Benefit:** 30% shock reduction → 310 fewer worsened cases  
**Delivery:** Mobile money-based premiums

#### 3. **Targeted Financial Literacy**
**Target:** Those with ≤2 correct literacy answers (12,847 people)  
**Intervention:** Mobile-based financial education via SMS/WhatsApp  
**Impact:** +1 literacy level → 5% improvement in outcomes  
...
├── ThePGs_DataSprint2026_Regenerated.pptx ← 7-slide presentation
├── visualizations/                        ← High-res charts (PNG)
│   ├── 01_executive_dashboard.png
│   ├── 02_model_performance.png
│   ├── 03_feature_importance.png
│   ├── 04_barriers_analysis.png
│   ├── 05_policy_impact.png
│   └── 06_county_risk_map.png
└── paramters/                             ← Supporting docs (screenshots)
```
...
1. **Executive Dashboard** - Crisis overview with key statistics
2. **Model Performance** - F1-score comparison across 6 algorithms
3. **Feature Importance** - Top 15 predictive factors (ranked)
4. **Barriers Analysis** - Mobile money vs. banking barriers breakdown
5. **Policy Impact Simulation** - Predicted outcomes for intervention scenarios
6. **County Risk Map** - Geographic heatmap of financial deterioration rates
